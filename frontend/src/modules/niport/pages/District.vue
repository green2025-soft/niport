...
<template>
        ...
        <div class="card-body">
          <DataTable
            ...
            :fields="[
              ...
              { key: 'name', label: 'জেলার নাম ইংলিশ' },
              { key: 'bn_name', label: 'জেলার নাম বাংলা' },
  ...
  >
    ...
    <BaseFormGroup label="জেলার নাম বাংলা" labelCols="12" required>
      <BFormInput v-model="form.name" />
    </BaseFormGroup>
    <BaseFormGroup label="জেলার নাম ইংলিশ" labelCols="12" required>
